...
class Ui_MEAFS(object):
    def setupUi(self, MEAFS):
        ...
        self.normspec = QtGui.QAction(parent=MEAFS)
        self.normspec.setObjectName("normspec")
        ...
        self.tabplotshels.setCurrentIndex(3)
        self.plotstab.setCurrentIndex(2)
        self.histplottab.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(MEAFS)
        MEAFS.setTabOrder(self.tabplotshels, self.linelistname)
        MEAFS.setTabOrder(self.linelistname, self.linelistbrowse)
        MEAFS.setTabOrder(self.linelistbrowse, self.linelistload)
        MEAFS.setTabOrder(self.linelistload, self.linelistcontent)
        MEAFS.setTabOrder(self.linelistcontent, self.linelistcheckbox)
        MEAFS.setTabOrder(self.linelistcheckbox, self.linelistaddline)
        MEAFS.setTabOrder(self.linelistaddline, self.linelistremoveline)
        MEAFS.setTabOrder(self.linelistremoveline, self.restart)
        MEAFS.setTabOrder(self.restart, self.refername)
        MEAFS.setTabOrder(self.refername, self.referbrowse)
        MEAFS.setTabOrder(self.referbrowse, self.referload)
        MEAFS.setTabOrder(self.referload, self.refercontent)
        MEAFS.setTabOrder(self.refercontent, self.referaddline)
        MEAFS.setTabOrder(self.referaddline, self.referremoveline)
        MEAFS.setTabOrder(self.referremoveline, self.methodsdatafittab)
        MEAFS.setTabOrder(self.methodsdatafittab, self.dataloadtable)
        MEAFS.setTabOrder(self.dataloadtable, self.delimitertype)
        MEAFS.setTabOrder(self.delimitertype, self.loaddata)
        MEAFS.setTabOrder(self.loaddata, self.methodbox)
        MEAFS.setTabOrder(self.methodbox, self.methodstab)
        MEAFS.setTabOrder(self.methodstab, self.ewfuncbox)
        MEAFS.setTabOrder(self.ewfuncbox, self.convinitguessvalue)
        MEAFS.setTabOrder(self.convinitguessvalue, self.depthinitguessvalue)
        MEAFS.setTabOrder(self.depthinitguessvalue, self.turbospectrumconfigname)
        MEAFS.setTabOrder(self.turbospectrumconfigname, self.turbospectrumconfigbrowse)
        MEAFS.setTabOrder(self.turbospectrumconfigbrowse, self.turbospectrumoutputname)
        MEAFS.setTabOrder(self.turbospectrumoutputname, self.turbospectrumoutputbrowse)
        MEAFS.setTabOrder(self.turbospectrumoutputbrowse, self.outputname)
        MEAFS.setTabOrder(self.outputname, self.outputbrowse)
        MEAFS.setTabOrder(self.outputbrowse, self.run)
        MEAFS.setTabOrder(self.run, self.stop)
        MEAFS.setTabOrder(self.stop, self.abundancetable)
        MEAFS.setTabOrder(self.abundancetable, self.lambshifvalue)
        MEAFS.setTabOrder(self.lambshifvalue, self.continuumvalue)
        MEAFS.setTabOrder(self.continuumvalue, self.convolutionvalue)
        MEAFS.setTabOrder(self.convolutionvalue, self.manualfitbutton)
        MEAFS.setTabOrder(self.manualfitbutton, self.abundancevalue)
        MEAFS.setTabOrder(self.abundancevalue, self.currentvaluesplotbutton)
        MEAFS.setTabOrder(self.currentvaluesplotbutton, self.currentvaluessavebutton)
        MEAFS.setTabOrder(self.currentvaluessavebutton, self.abundshift)
        MEAFS.setTabOrder(self.abundshift, self.linesplotall)
        MEAFS.setTabOrder(self.linesplotall, self.linesplotsingle)
        MEAFS.setTabOrder(self.linesplotsingle, self.boxplotcreate)
        MEAFS.setTabOrder(self.boxplotcreate, self.histbinsvalue)
        MEAFS.setTabOrder(self.histbinsvalue, self.hitsplotall)
        MEAFS.setTabOrder(self.hitsplotall, self.histplotsingle)
        MEAFS.setTabOrder(self.histplotsingle, self.histplottab)
        MEAFS.setTabOrder(self.histplottab, self.plotstab)
        MEAFS.setTabOrder(self.plotstab, self.stdtext)
        MEAFS.setTabOrder(self.stdtext, self.clearstdbutton)
    ...
    def retranslateUi(self, MEAFS):
        ...
        self.delimitertype.setItemText(1, _translate("MEAFS", "Auto"))
        self.delimitertype.setItemText(2, _translate("MEAFS", "Comma"))
        self.delimitertype.setItemText(3, _translate("MEAFS", "Tab"))
        self.delimitertype.setItemText(4, _translate("MEAFS", "FITS File"))
        ...
        self.depthinitguesslabel.setText(_translate("MEAFS", "Depth"))
